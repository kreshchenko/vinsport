        ...
        <ul class="menu">
            <li><a  href="#">ФУТБОЛ</a>
                <ul class="sub-menu">
                    ...
                    <li><a href="#">Футзал</a>
                        <ul>
                            <li><a href="../../index.php?view=cat&id=16">Вища ліга</a></li>
                            <li><a href="../../index.php?view=cat&id=17">Перша ліга</a></li>
                            <li><a href="../../index.php?view=cat&id=18">Друга ліга</a></li>
                            <li><a href="../../index.php?view=cat&id=38">Третя ліга</a></li>
